       ...
       <div class="scrollbar-sidebar">
           <div class="app-sidebar__inner">
               <ul class="vertical-nav-menu">
                   <li class="app-sidebar__heading"><a href="home.php"><i class="metismenu-icon pe-7s-home">
                           </i> Dashboard</a></li>
                   ...
                   <li class="app-sidebar__heading">MANAGE EXAM APPLICATIONS</li>
                   <li>
                       <a href="home.php?page=manage-applications">
                           <i class="metismenu-icon pe-7s-add-user">
                           </i>Manage Applications
                       </a>
                   </li>
